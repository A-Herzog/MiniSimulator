...
lang.GUI.tabModelInfo2='Im Kontext der analytischen Warteschlangentheorie können die Kenngrößen eines Modells, welches die oben genannten Eigenschaften vollständig nutzt, bereits nicht mehr exakt berechnet werden. Mit Hilfe von <a href="https://de.wikipedia.org/wiki/Ereignisorientierte_Simulation" target="_blank">ereignisorientierter stochastischer Simulation</a> können derartige Modelle jedoch problemlos untersucht werden. Mit <a href="#linkMore">umfangreicheren Simulationstools</a> können auch weit komplexere Modelle in kurzer Zeit simuliert werden.<br><br>Die im Folgenden verwendeten Begriffe werden im <a id="linkGlossary2">Glossar</a> definiert. Eine Kurzeinführung in das Thema Warteschlangentheorie und -simulation findet sich auf der Seite <a id="linkQt2">Grundkonzepte der Warteschlangentheorie</a> und eine ausführlichere Erklärung zum Thema Warteschlangensimulation kann im Lehrbuch <a href="https://www.springer.com/gp/book/9783658346676">Simulation mit dem Simulation mit dem Warteschlangensimulator</a> nachgelesen werden.';
lang.GUI.tabModelImage='Model_de';
...
lang.GUI.tabLanguageMode="Sprache";
lang.GUI.tabLanguageModeDe="Deutsch";
lang.GUI.tabLanguageModeEn="Englisch";
...
lang.model.servicePolicySJF='SJF - Shortest job first';
lang.model.servicePolicyLJF='LJF - Longest job first';
...
lang.GUI.tabLanguageMode="Language";
lang.GUI.tabLanguageModeDe="German";
lang.GUI.tabLanguageModeEn="English";
